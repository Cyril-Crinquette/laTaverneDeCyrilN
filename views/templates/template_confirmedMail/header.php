<!------------------ ------------------- Header de la page d'envoi du mail -------------- ------------------------- -->
...
<head>
    ...
    <link rel="stylesheet" href="/public/assets/css/css_confirmedMail/style.css">
    <!-- Chargement de la feuille de style correspondant à la page d'envoi du mail -->
</head>
        ...
        <div class="container-fluid d-none d-md-block navbarLaptop">
            <div class="row">
                ...
                <div class="col-8 titleHeader d-flex justify-content-center align-items-center">
                    <h1 id="pcTitle"> Inscription validée </h1>
                </div>
