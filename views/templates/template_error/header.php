...
<head>
    ...
    <link rel="stylesheet" href="/public/assets/css/css_error/style.css">
    <!-- Chargement de la feuille de style correspondant à la page d'erreur -->
</head>
