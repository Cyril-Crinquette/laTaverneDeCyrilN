...
<head>
    ...
    <link rel="stylesheet" href="/public/assets/css/css_dashBoardAdmin/style.css">
    <!-- Chargement de la feuille de style correspondant à la page dash board -->
</head>
